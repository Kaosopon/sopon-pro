...
<head>
  ...
  <!-- Favicons -->
  <link href="{{asset('admin/front_end/assets/img/favicon.jpg')}}" rel="icon">
  <link href="{{asset('admin/front_end/assets/img/apple-touch-icon.jpg')}}" rel="apple-touch-icon">
  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">

  <!-- Vendor CSS Files -->
  <link href="{{asset('admin/front_end/assets/vendor/animate.css/animate.min.css')}}" rel="stylesheet">
